...
function manipulate(root) {
	...
	var tspanY;
	var colorIndex;
	var colors = new Array ("#0000ff", "#00ff00", "#ff0000");
	var tspanColor;
	...
	svg.text(null, "18.78125", "111.66666", svgText, {style: "font-size:22px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;text-align:start;line-height:300%;writing-mode:lr-tb;fill:#000000;fill-opacity:1;stroke:none;font-family:Arial;-inkscape-font-specification:Arial"});
};